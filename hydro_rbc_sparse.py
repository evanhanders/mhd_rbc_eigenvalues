...
if __name__ == '__main__':
    ...
    for i, p in enumerate(problems):
        ...
        print('sparse solve {} condition number: {:.2e}'.format(i, np.linalg.cond(solver.pencils[0].L_exp.A)))
    ...
    fig.savefig('hydro_sparse_low_hi_res_ra{}_k{}.png'.format(Ra, k), bbox_inches='tight', dpi=300)
    plt.clf()
