...
if __name__ == '__main__':
    ...
    for j in range(3):
        ...
        fig.savefig('hydro_2d_nz{}_ra{}_k{}.png'.format(nzs[j], Ra, k), bbox_inches='tight', dpi=300)
        plt.clf()
    ...
    fig.savefig('hydro_2d_low_hi_res_ra{}_k{}.png'.format(Ra, k), bbox_inches='tight', dpi=300)
    plt.clf()
